  ...
  switch (preset) {
    case "weekly": {
      ...
      return {
        ...
        startDate: monday,
        endDate: sunday,
        periodLabel: "Week of " + fmt.format(monday) + " - " + fmt.format(sunday),
      };
    }
    ...
    case "quarterly": {
      ...
      return {
        ...
        startDate: start,
        endDate: end,
        periodLabel: quarterName + " (" + fmt.format(start) + " - " + fmt.format(end) + ")",
      };
    }
    ...
    case "biannually": {
      ...
      const halfName = isH1 ? "H1 " + currentYear + " (Jan - Jun)" : "H2 " + currentYear + " (Jul - Dec)";
      return {
        preset: "biannually",
        startDate: start,
        endDate: end,
