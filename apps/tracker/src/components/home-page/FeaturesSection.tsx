...
export function FeaturesSection() {
  ...
  return (
    <section id="features" className="py-24 border-t border-border/40 bg-secondary/10 scroll-mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-base sm:text-lg text-muted-foreground text-pretty">
            Everything designed around the real workflow of winning tenders, tracking validities, fulfilling purchase orders, and presenting reports.
          </p>
        </div>
            ...
            >
              ...
              <div className="pt-4 border-t border-border/50 space-y-2">
                {pillar.points.map((pt) => (
                  <div key={pt} className="flex items-center gap-2 text-xs text-foreground/90 font-medium">
        ...
        <div className="mt-14 text-center">
          <Button size="lg" asChild className="h-12 px-8 font-bold gap-2 bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg cursor-pointer">
            <Link href="/sign-up">
