      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 space-y-3">
          ...
          <p className="text-sm sm:text-base text-muted-foreground text-pretty">
            Choose the plan that fits your bidding volume. All paid features are
            100% unlocked for free during our public beta without a credit card.
          </p>
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-2xl bg-emerald-950/60 border border-emerald-700/60 text-emerald-300 text-xs font-bold shadow-xs">
            ...
            <span>
              🎉 Public Beta Special: All plans unlocked for free testing. No
                ...
                <div className="pt-4 border-t border-border/50 space-y-2.5">
                  ...
                  {Array.isArray(tier.features) &&
                    (tier.features as string[]).map((feature: string) => (
                      ...
                      >
                        <Check
                          className="h-3.5 w-3.5 text-emerald-400 shrink-0 mt-0.5 font-bold"
                          aria-hidden="true"
                        />
                        <span>{feature}</span>
                      </div>
