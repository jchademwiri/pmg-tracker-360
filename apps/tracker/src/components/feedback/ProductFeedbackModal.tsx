          ...
          <div className="space-y-6">
            ...
            <DialogHeader className="text-left space-y-2 pr-10">
              ...
              <DialogDescription className="text-sm text-muted-foreground">
                Your direct suggestions help shape Tender Track 360. Our product
                and engineering team reviews every submission.
              </DialogDescription>
            </DialogHeader>
          ...
          <div className="py-8 text-center space-y-5 animate-in fade-in-50 duration-200">
            ...
            <div className="space-y-1.5 max-w-md mx-auto">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Thank you for helping us make Tender Track 360 better. Our
                engineering and design team has been notified.
              </p>
            </div>
            <div className="pt-4">
              <Button
