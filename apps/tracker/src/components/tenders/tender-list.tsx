...
import {
  ...
  TableHeader,
  TableRow,
} from '@pmg/ui/components/ui/table';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
  DropdownMenuTrigger,
} from '@pmg/ui/components/ui/dropdown-menu';
import {
  Select,
  SelectContent,
  SelectItem,
  SelectTrigger,
  SelectValue,
} from '@pmg/ui/components/ui/select';
...
export function TenderList({
  ...
  const [totalCount, setTotalCount] = useState(initialTotalCount); // Used for client-side pagination
