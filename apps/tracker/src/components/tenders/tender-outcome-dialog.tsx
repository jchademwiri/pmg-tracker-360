...
const LostSchema = z.object({
  lossReason: z
    .string()
    .min(1, "Please select the primary reason for rejection"),
      ...
      <DialogContent className="sm:max-w-[760px] md:max-w-[820px] max-h-[90vh] overflow-y-auto">
        <DialogHeader className="pb-2">
          ...
          <DialogDescription className="text-muted-foreground text-xs sm:text-sm">
            ...
            . Select whether your submission was successfully appointed or
            rejected.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 pt-2">
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5 leading-snug">
                Client awarded the contract. Converts tender into an active
                project workspace.
              </p>
            </div>
          </button>
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5 leading-snug">
                Unsuccessful bid. Log debrief reasons & team learnings for
                retrospectives.
              </p>
            </div>
          </button>
          ...
          <Form {...awardForm}>
            ...
            >
              <div className="rounded-xl bg-emerald-500/10 border border-emerald-500/20 p-3 flex items-center gap-2.5 text-xs sm:text-sm text-emerald-800 dark:text-emerald-300">
                ...
                <span>
                  Great news! Confirming the award will initialize a project
                  workspace for contract delivery.
                </span>
              </div>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-xs font-semibold">
                      Appointment Notes / Scope Highlights
                    </FormLabel>
                    <FormControl>
                      <Textarea
              ...
              <div className="rounded-xl bg-amber-500/10 border border-amber-500/20 p-3 flex items-start gap-2.5 text-xs sm:text-sm text-amber-900 dark:text-amber-300">
                ...
                <div>
                  ...
                  <span className="text-xs text-muted-foreground">
                    Recording specific debrief notes helps our bidding team
                    understand gaps and win future tenders.
                  </span>
                </div>
              </div>
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="price">
                            Pricing too high / Competitor undercut
                          </SelectItem>
                          <SelectItem value="compliance">
                            Compliance / Missing returnable document
                          </SelectItem>
                          <SelectItem value="specs">
                            Technical specifications shortfall / Non-responsive
                          </SelectItem>
                          <SelectItem value="experience">
                            Track record / Insufficient references
                          </SelectItem>
                          <SelectItem value="score">
                            Functionality threshold not met (Scorecard)
                          </SelectItem>
                          <SelectItem value="cancelled">
                            Tender cancelled / Re-advertised by client
                          </SelectItem>
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription className="text-[11px]">
                      These notes will be displayed on the tender overview for
                      team retrospectives and future bids.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
