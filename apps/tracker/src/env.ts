  ...
  server: {
    ...
    R2_ACCOUNT_ID:
      process.env.VERCEL_ENV === "preview"
        ? z.string().default("preview-r2-account")
        : z.string().min(1, "R2_ACCOUNT_ID is required for file uploads"),
    R2_ACCESS_KEY_ID:
      process.env.VERCEL_ENV === "preview"
        ? z.string().default("preview-r2-access-key")
        : z.string().min(1, "R2_ACCESS_KEY_ID is required for file uploads"),
    ...
    R2_BUCKET_NAME:
      process.env.VERCEL_ENV === "preview"
        ...
        : z.string().min(1, "R2_BUCKET_NAME is required for file uploads"),
