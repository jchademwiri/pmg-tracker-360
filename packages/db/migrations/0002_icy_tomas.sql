ALTER TYPE "public"."role" ADD VALUE IF NOT EXISTS 'manager' BEFORE 'member';
...
--> statement-breakpoint
ALTER TABLE "contract" ADD COLUMN IF NOT EXISTS "deleted_at" timestamp;
--> statement-breakpoint
ALTER TABLE "contract" ADD COLUMN IF NOT EXISTS "deleted_by" text;
--> statement-breakpoint
ALTER TABLE "follow_up" ADD COLUMN IF NOT EXISTS "deleted_at" timestamp;
--> statement-breakpoint
ALTER TABLE "follow_up" ADD COLUMN IF NOT EXISTS "deleted_by" text;
--> statement-breakpoint
ALTER TABLE "organization" ADD COLUMN IF NOT EXISTS "deleted_at" timestamp;
--> statement-breakpoint
ALTER TABLE "organization" ADD COLUMN IF NOT EXISTS "deleted_by" text;
--> statement-breakpoint
ALTER TABLE "organization" ADD COLUMN IF NOT EXISTS "deletion_reason" text;
--> statement-breakpoint
ALTER TABLE "organization" ADD COLUMN IF NOT EXISTS "permanent_deletion_scheduled_at" timestamp;
--> statement-breakpoint
ALTER TABLE "tender" ADD COLUMN IF NOT EXISTS "deleted_at" timestamp;
--> statement-breakpoint
ALTER TABLE "tender" ADD COLUMN IF NOT EXISTS "deleted_by" text;
--> statement-breakpoint
DO $$ BEGIN
