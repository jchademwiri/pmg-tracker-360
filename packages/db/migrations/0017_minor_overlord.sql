DO $$ BEGIN
  ALTER TABLE "tender" DROP CONSTRAINT IF EXISTS "tender_tender_number_unique";
EXCEPTION
  WHEN others THEN null;
END $$;
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "invitation_organization_id_email_pending_unique" ON "invitation" USING btree ("organization_id","email") WHERE status = 'pending';
--> statement-breakpoint
DO $$ BEGIN
