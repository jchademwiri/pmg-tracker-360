...
ALTER TABLE "project" ADD COLUMN IF NOT EXISTS "contract_start_date" timestamp;--> statement-breakpoint
ALTER TABLE "project" ADD COLUMN IF NOT EXISTS "contract_end_date" timestamp;--> statement-breakpoint
ALTER TABLE "project" ADD COLUMN IF NOT EXISTS "award_value" numeric(15, 2);--> statement-breakpoint
