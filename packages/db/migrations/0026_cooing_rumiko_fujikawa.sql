...
CREATE UNIQUE INDEX IF NOT EXISTS "invitation_organization_id_email_pending_unique" ON "invitation" USING btree ("organization_id","email") WHERE status = 'pending'::"public"."invitation_status";--> statement-breakpoint
...
ALTER TABLE "project" ALTER COLUMN "status" SET DATA TYPE "public"."project_status" USING "status"::text::"public"."project_status";--> statement-breakpoint
ALTER TABLE "project" ALTER COLUMN "status" SET DEFAULT 'active'::"public"."project_status";--> statement-breakpoint
ALTER TABLE "project_risk" ALTER COLUMN "severity" DROP DEFAULT;--> statement-breakpoint
ALTER TABLE "project_risk" ALTER COLUMN "severity" SET DATA TYPE "public"."risk_severity" USING "severity"::text::"public"."risk_severity";--> statement-breakpoint
ALTER TABLE "project_risk" ALTER COLUMN "severity" SET DEFAULT 'medium'::"public"."risk_severity";--> statement-breakpoint
ALTER TABLE "project_risk" ALTER COLUMN "status" DROP DEFAULT;--> statement-breakpoint
ALTER TABLE "project_risk" ALTER COLUMN "status" SET DATA TYPE "public"."risk_status" USING "status"::text::"public"."risk_status";--> statement-breakpoint
ALTER TABLE "project_risk" ALTER COLUMN "status" SET DEFAULT 'open'::"public"."risk_status";--> statement-breakpoint
ALTER TABLE "purchase_order" ALTER COLUMN "status" DROP DEFAULT;--> statement-breakpoint
ALTER TABLE "purchase_order" ALTER COLUMN "status" SET DATA TYPE "public"."po_status" USING "status"::text::"public"."po_status";--> statement-breakpoint
...
ALTER TABLE "tender" ALTER COLUMN "status" DROP DEFAULT;--> statement-breakpoint
ALTER TABLE "tender" ALTER COLUMN "status" SET DATA TYPE "public"."tender_status" USING "status"::text::"public"."tender_status";--> statement-breakpoint
ALTER TABLE "tender" ALTER COLUMN "status" SET DEFAULT 'open'::"public"."tender_status";--> statement-breakpoint
ALTER TABLE "tender" ALTER COLUMN "priority" DROP DEFAULT;--> statement-breakpoint
ALTER TABLE "tender" ALTER COLUMN "priority" SET DATA TYPE "public"."tender_priority" USING "priority"::text::"public"."tender_priority";--> statement-breakpoint
ALTER TABLE "tender" ALTER COLUMN "priority" SET DEFAULT 'medium'::"public"."tender_priority";--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_client_org_id" ON "client" USING btree ("organization_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_doc_tender_id" ON "document" USING btree ("tender_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_doc_project_id" ON "document" USING btree ("project_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_doc_po_id" ON "document" USING btree ("purchase_order_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_member_org_id" ON "member" USING btree ("organization_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_member_user_id" ON "member" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_project_status" ON "project" USING btree ("status");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_project_org_id" ON "project" USING btree ("organization_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_po_project_id" ON "purchase_order" USING btree ("project_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_po_org_id" ON "purchase_order" USING btree ("organization_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_tender_status" ON "tender" USING btree ("status");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_tender_client_id" ON "tender" USING btree ("client_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_tender_org_id" ON "tender" USING btree ("organization_id");--> statement-breakpoint
DO $$ BEGIN
