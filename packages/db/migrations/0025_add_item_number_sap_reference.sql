CREATE TABLE "project_line_item" (
	...
	"item_number" text DEFAULT 'ITEM' NOT NULL,
	"sap_reference" text,
...
ALTER TABLE "purchase_order_delivery_note" ADD COLUMN "project_id" text NOT NULL;--> statement-breakpoint
ALTER TABLE "purchase_order_line_item" ADD COLUMN "project_line_item_id" text;--> statement-breakpoint
ALTER TABLE "purchase_order_line_item" ADD COLUMN "item_number" text DEFAULT 'ITEM' NOT NULL;--> statement-breakpoint
ALTER TABLE "purchase_order_line_item" ADD COLUMN "sap_reference" text;--> statement-breakpoint
...
ALTER TABLE "purchase_order_delivery_note" ADD CONSTRAINT "purchase_order_delivery_note_project_id_project_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."project"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
