...
| 6.5 | **Convert remaining forms to steppers** | Complex forms still single-page on mobile | L | `apps/tracker/src/components/ui/form-stepper.tsx`, tender/PO forms | ✅ Done |
...
- [✓] Multi-step forms on mobile (shared FormStepper + tender/PO form conversions)
